...
data_tidy <- data_species %>% pivot_longer(cols = starts_with("biomass"), names_to = "trait") 
```
...
```{r}
data_biomass <- data_tidy_sep %>% pivot_wider(names_from = biomass_type, values_from = value)
```
